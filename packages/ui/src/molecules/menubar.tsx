...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Label
    ref={ref}
    className={cn('px-4 py-2 text-sm font-bold uppercase tracking-wide text-foreground', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Separator ref={ref} className={cn('my-2 h-px bg-border', className)} {...props} />
));
